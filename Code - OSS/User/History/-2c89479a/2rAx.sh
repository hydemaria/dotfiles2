...
#opcoes="<span color='#503850' background='#ff8e9e'>Desligar</span>\n<span color='#503850' background='#ffd6dc'>Reiniciar</span>"

# Abre o rofi usando o tema energia.rasi e habilitando o markup
escolha=$(rofi -dmenu -p "Energia" -markup-rows -theme ~/.config/rofi/energia.rasi)
